/**
* @file 	dambreak_module.hpp
* @brief 	Python binding for dambreak flow in SPHinxsys library.
* @author	Chi Zhang
* @version  1.0 
*			Start the python binding work.
*           Follow Bo ZHANG's example in SPHinXsys of Bitbucket, futher binding should be embeded. 
*			-- Chi ZHANG
*/
